...
<body style="background-color: #fde5d5;">
    ...
    <div class="welcome">
    <center>
        <h1 class="alert alert-danger"style="color:#fc6500;">You've successfully logged out.</h1>
        <br>
        <h3 style="color:#ff954e;">You may login or create a new account by clicking below.
        </h3>
